...
A fejezetben a projekt felhasználási lehetőségeit mutatom, valamint \az{\ref{kövspec}.~fejezetben} \az{\pageref{követelmény}.~oldalon} megfogalmazottaknak feleltetem meg a termékemet, majd bemutatom a fejlesztés során használt készüléket.
...
A programban ezt \az{\pageref{követelmény}.~oldalon} megfogalmazottaknak eleget téve \az{\ref{követelmény}~kódrészletben} látható módon egy metódusba építettem.
