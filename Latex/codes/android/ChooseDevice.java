devices.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View arg0) {
        ...
        if (mBTAdapter == null) {
            Toast.makeText(getApplicationContext(), "Nincs Bluetooth modul!", Toast.LENGTH_SHORT).show();
...
follow.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View arg0) {
        BluetoothDevice device = ((MyAdapter) (listView.getAdapter())).getSelectedItem(); //A listából kiválasztott eszköz
